...
export const createPayment = async (req, res) => {
  try {
    ...
    res.status(200).json({ message: 'Pago móvil registrado.' });
  } catch (error) {
...
export const activatePayment = async (req, res) => {
  try {
    ...
    res.status(200).json({ message: 'Pago móvil activado.' });
  } catch (error) {
    res.status(500).json({ message: 'Error al activar el pago móvil.' });
  }
};
...
export const deletePayment = async (req, res) => {
  try {
    ...
    res.status(200).json({ message: 'Pago móvil eliminado.' });
  } catch (error) {
    res.status(500).json({ message: 'Error al eliminar el pago móvil.' });
  }
};
...
export const getAllPayments = async (_req, res) => {
  try {
    ...
    res.status(500).json({ message: 'Error al obtener los pagos móviles.' });
  }
};
...
export const getActivePayment = async (_req, res) => {
  try {
    ...
    res.status(500).json({ message: 'Error al obtener el pago móvil activo.' });
  }
};