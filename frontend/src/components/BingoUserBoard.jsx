          ...
          <div key={col.letter} className="border border-white/10">
            {Array.from({ length: 15 }, (_, i) => {
              ...
              return (
                <div
                  key={number}
                  className={`h-4 desk:h-3 desk:text-xs desk:mb-[0.07rem] desklg:text-sm desklg:h-5 desklg:mb-[0.065rem] flex mb-[0.065rem] font-semibold text-xs font-inter items-center justify-center transition-all duration-200
                    ${
                      isLastCalled
