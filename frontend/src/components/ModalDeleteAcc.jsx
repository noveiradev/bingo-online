...
export default function ModalDeleteAcc({ modalFunction, modalView }) {
  ...
  return (
    <>
      {!showAcceptModal ? (
        <section className="absolute z-10 top-0 left-0 w-full h-dvh bg-[#000]/60 overflow-hidden">
          <Slide
            direction="up"
            triggerOnce
            duration={600}
          ...
          >
            <article className="max-w-[350px] w-[95%] h-[25rem] desk:mt-10 bg-white/10 mx-auto mt-24 backdrop-blur-lg rounded-2xl shadow-[#000]/50 shadow-lg outline-[#4E4E4B] outline-3 font-poppins">
